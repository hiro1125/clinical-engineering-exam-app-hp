    ...
    <>
      <div className='w-full h-full'>
        <div className='flex flex-col items-center justify-center'>
          <h2 className='text-2xl font-bold mt-20'>お問い合わせ</h2>
          <p className='text-base font-bold justify-center mt-8'>
          ...
          <form ref={form} onSubmit={sendEmail}>
            <label htmlFor='mailTitleForm' className='font-bold text-lg'>
              件名<span className='text-red-500'>*</span>
            </label>
            <input
              id='mailTitleForm'
              className='border border-gray-300 rounded px-3 py-2 w-full bg-gray-100 text-xl mb-2'
              type='text'
              placeholder='件名'
              name='subject'
              required
            />
            <label htmlFor='mailForm' className='font-bold text-lg'>
            ...
            <input
              ...
              required
            />
            <label htmlFor='mailContentForm' className='font-bold text-lg'>
